...
PP_MCARE_OBJECT_STAT_TIMEOUT_SECONDS = _positive_int_env(
    "PP_MCARE_OBJECT_STAT_TIMEOUT_SECONDS", 10
)
PP_MCARE_OBJECT_STAT_RETRIES = _positive_int_env("PP_MCARE_OBJECT_STAT_RETRIES", 2)
...
QINIU_DIRECT_UPLOAD_URL = os.getenv("QINIU_DIRECT_UPLOAD_URL", "")
QINIU_DIRECT_UPLOAD_TOKEN_TTL_SECONDS = _positive_int_env("QINIU_DIRECT_UPLOAD_TOKEN_TTL_SECONDS", 3600)
...
PP_MCARE_DOWNLOAD_TOKEN_TTL_SECONDS = int(
    os.getenv("PP_MCARE_DOWNLOAD_TOKEN_TTL_SECONDS", "3600")
)
PP_MCARE_UPLOAD_TOKEN_TTL_SECONDS = int(
    os.getenv("PP_MCARE_UPLOAD_TOKEN_TTL_SECONDS", "10800")
)
