...
from .history_views import TrainingHistoryListView, TrainingHistoryDetailView
...
urlpatterns = [
    path("history/", TrainingHistoryListView.as_view()),
    path("history/<int:record_id>/", TrainingHistoryDetailView.as_view()),
