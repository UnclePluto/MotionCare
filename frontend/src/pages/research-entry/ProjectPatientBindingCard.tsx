...
import { Alert, Button, Descriptions, Divider, Space, Tag, Typography } from "antd";
import dayjs from "dayjs";
import { useEffect, useRef } from "react";

import { apiClient } from "../../api/client";
import { WearableBindingPanel } from "../wearables/WearableBindingPanel";
  ...
  return (
    <Space direction="vertical" size="middle" style={{ width: "100%" }}>
      <Space style={{ width: "100%", justifyContent: "space-between" }} wrap>
        <Typography.Text strong>小程序临时绑定码</Typography.Text>
        <Space wrap>
      ...
      <Descriptions size="small" bordered column={{ xs: 1, sm: 3 }}>
        <Descriptions.Item label="绑定状态">{status?.has_active_session ? <Tag color="green">已绑定</Tag> : <Tag>未绑定</Tag>}</Descriptions.Item>
