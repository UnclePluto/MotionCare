...
function createDemoMotionAction(
  ...
  return {
    ...
    has_ai_supervision: false,
    weekly_frequency: definition.sourceKey === 'motion-aerobic-high-knee' ? '体验一次' : '每周3次',
    duration_minutes: definition.sourceKey === 'motion-aerobic-high-knee' ? 10 : null,
    dose_mode: definition.sourceKey === 'motion-aerobic-high-knee' ? 'duration' as const : 'sets' as const,
    repetitions: definition.sourceKey === 'motion-aerobic-high-knee' ? null : 10,
    sets: definition.sourceKey === 'motion-aerobic-high-knee' ? null : 3,
    count_unit: definition.sourceKey === 'motion-resistance-leg-kickback' ? 'per_side' as const : 'total' as const,
    weekly_target_count: definition.sourceKey === 'motion-aerobic-high-knee' ? 1 : 3,
    weekly_completed_count: 0,
    difficulty: '简单',
    notes: '',
    sort_order: index + 7,
