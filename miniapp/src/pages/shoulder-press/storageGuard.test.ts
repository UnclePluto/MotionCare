...
import { cleanupAndCheckShoulderPressStorage } from './storageGuard'

const MB = 1024 * 1024

describe('cleanupAndCheckShoulderPressStorage', () => {
  ...
  it('short-circuits a pending session without accessing saved files', async () => {
    ...
    await expect(cleanupAndCheckShoulderPressStorage({
